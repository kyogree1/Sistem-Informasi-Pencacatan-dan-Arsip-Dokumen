            ...
            <div class="rounded-2xl bg-white dark:bg-slate-900 shadow-lg shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800 overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-slate-50 to-slate-100/50 dark:from-slate-800 dark:to-slate-900 px-6 py-4 border-b border-slate-100 dark:border-slate-800">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-sm font-bold text-[#12284B] dark:text-slate-100">Form Data Arsip</h3>
                            <p class="text-xs text-slate-500 dark:text-slate-400">Lengkapi semua informasi dokumen debitur</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('archive.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                                ...
                                <div class="md:col-span-2 lg:col-span-3">
                                    ...
                                    <textarea name="keterangan" rows="3"
                                        class="input-field" placeholder="Catatan tambahan...">{{ old('keterangan') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-muted p-5">
                            ...
                            {{-- Input Berkas --}}
                            <div>
                                <label class="block text-sm font-semibold text-slate-700 dark:text-slate-200 mb-1.5">Pilih Berkas</label>
                                ...
                                <p class="mt-1 text-xs text-slate-400 dark:text-slate-500">Format: PDF, JPG, PNG (Max 5MB)</p>
                            </div>
                        </div>

                        {{-- INFO --}}
                        <div class="flex items-start gap-2 rounded-xl bg-sky-50 dark:bg-sky-500/10 border border-sky-100 dark:border-sky-700/60 p-3 text-xs text-sky-700 dark:text-sky-200">
