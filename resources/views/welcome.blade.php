...
<head>
    ...
    <style>
        * { font-family: 'Inter', sans-serif; }
        .hero-gradient { background: linear-gradient(135deg, #12284B 0%, #0f3a6e 40%, #0c4a8a 70%, #0EA5E9 100%); }
...
<body class="bg-slate-50">
    ...
    <header class="fixed inset-x-0 top-0 z-50">
        <nav class="flex items-center justify-between px-6 py-4 lg:px-12 bg-[#12284B]/90 backdrop-blur-lg border-b border-white/10">
            ...
            <a href="{{ route('login') }}"
               class="rounded-lg bg-white px-5 py-2 text-sm font-semibold text-[#12284B] hover:bg-sky-50 transition-all duration-200 shadow-sm">
                Masuk
            </a>
        </nav>
    </header>
    ...
    <section class="hero-gradient relative min-h-screen flex items-center overflow-hidden">
        ...
        <div class="relative max-w-6xl mx-auto px-6 lg:px-8 pt-32 pb-20 text-center">
            ...
            <div class="fade-up fade-up-d4 mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="{{ route('login') }}"
                   class="rounded-xl bg-white px-8 py-3.5 text-sm font-bold text-[#12284B] hover:bg-sky-50 transition-all duration-300 shadow-lg shadow-black/20 hover:shadow-xl hover:shadow-black/30">
                    Mulai Sekarang →
                </a>
            </div>
    ...
    <section class="py-24 bg-white">
        <div class="max-w-6xl mx-auto px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <h2 class="text-3xl sm:text-4xl font-bold text-[#12284B]">Solusi Arsip Digital Terpadu</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="card-hover rounded-2xl border border-slate-100 bg-white p-8 text-center">
                    ...
                    <h3 class="text-lg font-bold text-[#12284B] mb-2">Arsip Digital</h3>
                ...
                <div class="card-hover rounded-2xl border border-slate-100 bg-white p-8 text-center">
                    ...
                    <h3 class="text-lg font-bold text-[#12284B] mb-2">Keamanan Terjamin</h3>
                ...
                <div class="card-hover rounded-2xl border border-slate-100 bg-white p-8 text-center">
                    ...
                    <h3 class="text-lg font-bold text-[#12284B] mb-2">Monitoring Real-time</h3>
